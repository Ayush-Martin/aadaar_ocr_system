  ...
  const handleCopyText = () => {
    if (data) {
      const textToCopy = [
        ...
        `Age: ${data.age || "N/A"}`,
        `Age Band: ${data.ageBand || "N/A"}`,
        `Aadhaar Number: ${data.uid || "N/A"}`,
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {data && !loading && success && (
          <button
            ...
            className="px-3 py-1.5 text-sm font-medium text-[#432dd7] hover:bg-[#432dd7]/10 rounded-lg transition-colors duration-200"
          >
