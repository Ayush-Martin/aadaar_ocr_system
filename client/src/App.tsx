      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-auto">
        <aside className="lg:w-2/5 w-full bg-white border-r lg:border-r border-b lg:border-b-0 px-6 py-8 flex flex-col justify-between shadow-sm">
          ...
          <div className="mt-8 space-y-3">
            <button
              className="w-full py-3 bg-[#432dd7] hover:bg-[#3520b0] text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ease-snappy"
              onClick={submit}
            >
              Parse Aadhaar
            </button>
            {(frontImage || backImage || response) && (
              <button
                className="w-full py-3 bg-white border-2 border-[#432dd7] text-[#432dd7] hover:bg-[#432dd7] hover:text-white font-semibold rounded-xl transition-all duration-300 ease-snappy"
                onClick={reset}
              >
                Reset
              </button>
